...
>(
  (
    { side = "right", className, children, closeButton = "x", ...props },
    ref
  ) => (
    <SheetPortal>
      <SheetOverlay />
      ...
      >
        ...
        {closeButton === "x" ? (
          ...
          <div className="absolute w-full left-0 flex justify-center top-4">
            <div className="w-full px-4 bg-white pb-2 max-w-[1280px] flex">
              <SheetPrimitive.Close className="rounded-sm ring-offset-white transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-slate-950 focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-slate-100 dark:ring-offset-slate-950 dark:focus:ring-slate-300 dark:data-[state=open]:bg-slate-800">
                <ArrowLeft color="#892217" />
                <span className="sr-only">Close</span>
              </SheetPrimitive.Close>
            </div>
          </div>
